        ...
        do{
            ...
            if(maneuver!=0){
                ...
                if (i==3){
                    if(A+manettat<0){
                        A=0-manettat; 
                        printf("[~]WARNING: Ampiezza minore del minimo consentito... Impostata ampiezza a %g\n", 0-manettat);
                    }
                    if(A+manettat>1){
                        A=1-manettat; 
                        printf("[~]WARNING: Ampiezza maggiore del massimo consentito... Impostata ampiezza a %g\n", 1-manettat);
                    }
                }else if (i==1){
                    if(A+et<-20){
                        A=-20-et; 
